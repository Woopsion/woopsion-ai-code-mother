package com.woopsion.woopsionaicodemother.genresult;
...
public class MyBatisCodeGenerator {
    ...
    public static GlobalConfig createGlobalConfig() {
        ...
        globalConfig.getPackageConfig()
                .setBasePackage("com.woopsion.woopsionaicodemother.genresult");
        ...
        globalConfig.getJavadocConfig()
                .setAuthor("<a href=\"https://github.com/Woopsion\">woopsion</a>")
                .setSince("");
        return globalConfig;
    }
}
