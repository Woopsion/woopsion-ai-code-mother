...
// 代码生成类型
const codeGenType = ref<'html' | 'multi_files'>('html')
...
<template>
  <div id="homePage">
    ...
    <div class="type-selector">
      <a-radio-group v-model:value="codeGenType" size="small">
        <a-radio-button value="html">原生 HTML 模式</a-radio-button>
        <a-radio-button value="multi_files">多文件模式</a-radio-button>
      </a-radio-group>
    </div>
